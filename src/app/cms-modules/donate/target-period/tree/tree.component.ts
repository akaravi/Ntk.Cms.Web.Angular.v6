...
@Component({
  selector: 'app-donate-target-period-tree',
  templateUrl: './tree.component.html',
})
export class DonateTargetPeriodTreeComponent implements OnInit, OnDestroy {
  constructor(
  ...
  onActionEdit(): void {
    ...
    const dialogRef = this.dialog.open(DonateTargetPeriodEditComponent, {
      height: '90%',
      data: { id }
    });
    dialogRef.afterClosed().subscribe(result => {

...
import {
  CoreEnumService, CoreUserGroupModel, CoreUserGroupService, DataFieldInfoModel, EnumInfoModel, EnumManageUserAccessDataTypes, ErrorExceptionResult,
  FormInfoModel
} from 'ntk-cms-api';
...
export class CoreUserGroupEditComponent implements OnInit {
  ...
  DataGetOneContent(): void {
    ...
    this.coreUserGroupService.setAccessDataType(EnumManageUserAccessDataTypes.Editor);

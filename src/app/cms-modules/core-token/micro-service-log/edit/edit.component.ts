...
import {
  CoreEnumService, CoreTokenMicroServiceLogModel, CoreTokenMicroServiceLogService, DataFieldInfoModel, EnumInfoModel, EnumManageUserAccessDataTypes, ErrorExceptionResult,
...
export class CoreTokenMicroServiceLogEditComponent implements OnInit, OnDestroy {
  ...
  DataGetOneContent(): void {
    ...
    this.coreTokenMicroServiceLogService.setAccessDataType(EnumManageUserAccessDataTypes.Editor);

...
import {
  CoreEnumService, CoreTokenUserLogModel, CoreTokenUserLogService, DataFieldInfoModel, EnumInfoModel, EnumManageUserAccessDataTypes, ErrorExceptionResult,
...
export class CoreTokenUserLogEditComponent implements OnInit, OnDestroy {
  ...
  DataGetOneContent(): void {
    ...
    this.coreTokenUserLogService.setAccessDataType(EnumManageUserAccessDataTypes.Editor);

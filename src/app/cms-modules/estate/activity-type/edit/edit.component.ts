...
import {
  CoreEnumService, DataFieldInfoModel, EnumInfoModel, EnumManageUserAccessDataTypes, ErrorExceptionResult, EstateActivityTypeModel, EstateActivityTypeService, EstatePropertyTypeModel, EstatePropertyTypeService, EstatePropertyTypeUsageModel, FilterDataModel, FilterModel, FormInfoModel
} from 'ntk-cms-api';
...
export class EstateActivityTypeEditComponent implements OnInit {
  ...
  DataGetOneContent(): void {
    ...
    this.estateActivityTypeService.setAccessDataType(EnumManageUserAccessDataTypes.Editor);
